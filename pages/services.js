    ...
    <div className = {style.pricing}>
      ...
      <div className = {style.pricecontainer}>
        <div className = {style.photoprice}>
          ...
          <p>Contact us today to create a tailor made digitization package for your business!</p>
          <h3>What it includes:</h3>
          <p>- 1 Youtube advertisement, 3 Vertical media content</p>
          <p>- Custom-made Next.js Fullstack website with latest SEO features for visibility</p>
        ...
        <div className = {style.mediaservices}>
          <div className = {style.photoprice}>
            ...
            <div className = {style.para}>
              <h2>Social Influencer Package:</h2>
